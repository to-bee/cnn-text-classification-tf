    ...
    with tf.Graph().as_default():
        ...
        with sess.as_default():
            cnn = TextCNN(
                ...
                num_filters=128,
                l2_reg_lambda=ci.l2_reg_lambda)
            ...
            def train_step(x_batch, y_batch):
                ...
                feed_dict = {
                    cnn.input_x: x_batch,
                    cnn.y_true: y_batch,
                    cnn.dropout_keep_prob: ci.dropout_train
                }
            ...
            # Generate batches
            batches = data_helpers.batch_iter(list(zip(x_train, y_train)), ci.batch_size, ci.train_steps)
