...
tf.flags.DEFINE_string("checkpoint_dir", "./runs/1541540567/checkpoints/", "Checkpoint directory from training run")
...
# x_raw = ["I sell you viagra. Call me."]
# y_test = [0, 1, 0]
